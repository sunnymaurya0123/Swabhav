...
<body>
	...
	<br>
	<%
out.print("<table style='text-align:center' border=3 align='center'><thead><th>FirstName</th><th>LastName</th><th>EmailId</th><th>Phone No</th><th>Update Info</th><th>Remove Info</th></thead>");
		List<Contact> contacts=(List)request.getAttribute("contactlist");
		out.print("<tbody>");
		for(Contact contact:contacts){
			out.print("<tr><td> "+contact.getFirstName()
			+"</td><td>"+contact.getLastName()
			+"</td><td>"+contact.getEmailId()
			+"</td><td>"+contact.getPhoneNo()
			+"</td>");
			out.print("<td><a href='edit?id="+contact.getId()+"'>Edit</a></td>");
			out.print("<td><a href='delete?id="+contact.getId()+"'>Delete</a></td></tr>");
		}
		out.print("</tbody>");
		//out.print("<a href='http://localhost:8080/contacts-mvc-app/addContacts.jsp'>Add Contacts</a>");
	out.print("</table>");
// 	out.close();
	%>
	<br>
